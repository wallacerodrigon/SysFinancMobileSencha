...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../../../../../C:/Users/wallace/bin/Sencha/Cmd/6.2.2.36/plugins/src",
  ...
  "SysFinancMob": "../../app",
  "SysFinancMob.view.Login": "../../app/view/Main.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "SysFinancMob.controller.contas.GeradorLancamento": [],
  "SysFinancMob.controller.contas.Lancamentos": [],
  "SysFinancMob.controller.contas.MapaContas": [],
  "SysFinancMob.controller.contas.SubMenuFinanceiro": [],
  "SysFinancMob.controller.login.Login": [],
  "SysFinancMob.controller.menu.Menu": [],
  "SysFinancMob.controller.rateio.RateioController": [],
  "SysFinancMob.model.Usuario": [],
  "SysFinancMob.model.contas.Conta": [],
  "SysFinancMob.model.contas.ContasPorClassificacao": [],
  "SysFinancMob.model.contas.ContasPorFormaPagamento": [],
  "SysFinancMob.model.contas.ContasPorTipo": [],
  "SysFinancMob.model.contas.FormaPagamento": [],
  "SysFinancMob.model.contas.Lancamento": [],
  "SysFinancMob.model.contas.MapaContas": [],
  "SysFinancMob.model.contas.TipoConta": [],
  "SysFinancMob.model.menu.ItemMenu": [],
  "SysFinancMob.model.rateio.RateioModel": [],
  "SysFinancMob.store.Usuario": [],
  "SysFinancMob.store.Utils.URLConstants": [
    "URLConstants"
  ],
  "SysFinancMob.store.contas.Conta": [],
  "SysFinancMob.store.contas.ContasPorClassificacao": [],
  "SysFinancMob.store.contas.ContasPorFormaPagamento": [],
  "SysFinancMob.store.contas.ContasPorTipo": [],
  "SysFinancMob.store.contas.FormaPagamento": [],
  "SysFinancMob.store.contas.Lancamento": [],
  "SysFinancMob.store.contas.LancamentoRateioStore": [],
  "SysFinancMob.store.contas.MapaContas": [],
  "SysFinancMob.store.rateio.RateioStore": [],
  "SysFinancMob.view.Login": [],
  "SysFinancMob.view.Msgs.MsgProgresso": [
    "MsgProgresso"
  ],
  "SysFinancMob.view.contas.EditorLancamento": [],
  "SysFinancMob.view.contas.GeradorLancamento": [],
  "SysFinancMob.view.contas.Lancamentos": [],
  "SysFinancMob.view.contas.ListaContas": [],
  "SysFinancMob.view.contas.ResultLancamentos": [],
  "SysFinancMob.view.contas.ResultMapaContas": [],
  "SysFinancMob.view.contas.ResultMapaTabelaContas": [],
  "SysFinancMob.view.contas.UtilizadorLancamento": [],
  "SysFinancMob.view.graficos.TelaGraficos": [],
  "SysFinancMob.view.menu.Menu": [],
  "SysFinancMob.view.menu.SubMenuFinanceiro": [],
  "SysFinancMob.view.rateio.RateioEdicaoLancamento": [],
  "SysFinancMob.view.rateio.RateioForm": [],
  "SysFinancMob.view.rateio.RateioLancamentos": [],
  "SysFinancMob.view.rateio.RateioLancamentosSelecionados": [],
  "SysFinancMob.view.toolbars.Bottom": [],
  "SysFinancMob.view.toolbars.ConsultaBottomBar": [],
  "SysFinancMob.view.toolbars.EditBottomBar": [],
  "SysFinancMob.view.toolbars.HeaderBar": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "SysFinancMob.controller.UtilRequisicao": [],
  "SysFinancMob.controller.contas.GeradorLancamento": [
    "widget.geradorController"
  ],
  "SysFinancMob.controller.contas.Lancamentos": [
    "widget.lancamentocontroller"
  ],
  "SysFinancMob.controller.contas.MapaContas": [
    "widget.mapaContascontroller"
  ],
  "SysFinancMob.controller.contas.SubMenuFinanceiro": [],
  "SysFinancMob.controller.login.Login": [
  ...
  "SysFinancMob.model.contas.ContasPorClassificacao": [
    "widget.contasClassificacaoModel"
  ],
  "SysFinancMob.model.contas.ContasPorFormaPagamento": [
    "widget.contasFormaPagamento"
  ],
  "SysFinancMob.model.contas.ContasPorTipo": [
    "widget.contasPorTipo"
  ],
  "SysFinancMob.model.contas.FormaPagamento": [
    "widget.formaPagamentoModel"
  ],
  "SysFinancMob.model.contas.Lancamento": [
    "widget.lancamentoModel"
  ],
  "SysFinancMob.model.contas.MapaContas": [
    "widget.mapaContasModel"
  ],
  "SysFinancMob.model.contas.TipoConta": [
    "widget.tipoContaModel"
  ],
  "SysFinancMob.model.menu.ItemMenu": [
    "widget.itemmenumodel"
  ],
  "SysFinancMob.model.rateio.RateioModel": [
    "widget.rateioModel"
  ],
  ...
  "SysFinancMob.view.Msgs.MsgProgresso": [],
  "SysFinancMob.view.contas.EditorLancamento": [
    "widget.editorLancamento"
  ],
  "SysFinancMob.view.contas.GeradorLancamento": [
    "widget.geradorLancamento"
  ],
  "SysFinancMob.view.contas.Lancamentos": [
    "widget.lancamentoBusca"
  ],
  "SysFinancMob.view.contas.ListaContas": [
    "widget.lstContas"
  ],
  "SysFinancMob.view.contas.ResultLancamentos": [
    "widget.lstLancamentos"
  ],
  "SysFinancMob.view.contas.ResultMapaContas": [
    "widget.resultMapaContas"
  ],
  "SysFinancMob.view.contas.ResultMapaTabelaContas": [
    "widget.resultMapaTabelaContas"
  ],
  "SysFinancMob.view.contas.UtilizadorLancamento": [
    "widget.utilizadorLancamento"
  ],
  "SysFinancMob.view.graficos.TelaGraficos": [
    "widget.telaGraficos"
  ],
  ...
  "SysFinancMob.view.menu.SubMenuFinanceiro": [
    "widget.subMenuFinanceiro"
  ],
  "SysFinancMob.view.rateio.RateioEdicaoLancamento": [
    "widget.editorRateioLancamento"
  ],
  "SysFinancMob.view.rateio.RateioForm": [
    "widget.frmRateio"
  ],
  "SysFinancMob.view.rateio.RateioLancamentos": [
    "widget.lstLancamentosRateio"
  ],
  "SysFinancMob.view.rateio.RateioLancamentosSelecionados": [
    "widget.lstRateioLancamentosSelecionados"
  ],
  "SysFinancMob.view.toolbars.Bottom": [
    "widget.bottombar"
  ],
  "SysFinancMob.view.toolbars.ConsultaBottomBar": [
    "widget.consultabottombar"
  ],
  "SysFinancMob.view.toolbars.EditBottomBar": [
